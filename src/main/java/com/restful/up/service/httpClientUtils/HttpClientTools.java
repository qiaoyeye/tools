...
public class HttpClientTools {
    ...
    public static String runGet(String str,String url){
        if((!str.equals( "" )|| str != null)|| (!url.equals( "" )|| url != null) ){
         return    doGet(url,StringtoMap(str),CHARSET);
        }
        return null;
    }
